...
export interface VerifierZKInterface extends Interface {
...
export interface VerifierZK extends BaseContract {
  connect(runner?: ContractRunner | null): VerifierZK;
  waitForDeployment(): Promise<this>;

  interface: VerifierZKInterface;
